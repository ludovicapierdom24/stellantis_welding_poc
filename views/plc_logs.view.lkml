# The name of this view in Looker is "Plc Logs"
view: plc_logs {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `molding_anomaly_poc.plc_logs` ;;
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # This dimension will be called "Message Weld Log Contact Wait Time" in Explore.
...
# The name of this view in Looker is "Plc Logs Message Weld Log Force Curve"
view: plc_logs__message__weld_log__force_curve {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Plc Logs Message Weld Log Force Curve" in Explore.
...
# The name of this view in Looker is "Plc Logs Message Weld Log Voltage Curve"
view: plc_logs__message__weld_log__voltage_curve {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Plc Logs Message Weld Log Voltage Curve" in Explore.
...
# The name of this view in Looker is "Plc Logs Message Weld Log Current Curve"
view: plc_logs__message__weld_log__current_curve {
  ...
  # define primary_key: yes on a dimension that has no repeated values.
    ...
    # Here's what a typical dimension looks like in LookML.
    # A dimension is a groupable field that can be used to filter query results.
    # This dimension will be called "Plc Logs Message Weld Log Current Curve" in Explore.
