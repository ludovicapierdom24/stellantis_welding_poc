...
dimension: shift {
  ...
  dimension: cover {
    ...
    <!-- Header ottimizzato con Flexbox per evitare sovrapposizioni -->
    ...
    <ul style="margin-bottom: 25px; font-size: 15px; padding-left: 40px;">
        ...
        <li style="margin-bottom: 6px;">🔬 <strong>02. Advanced Engineering & Diagnostics (Process Engineers):</strong> A detailed analytical environment. It allows users to explore the physical attribution of anomalies, analyze resistance signature envelopes, and query the data logs using Gemini's intelligent diagnostic assistant.</li>
    </ul>
